...
const dragTask = inject('dragTask')
...
const onDrop = () => {
  changeColumnId(dragTask.value.id, props.column.id)
  isDragOver.value = false
}

const onDragover = (e) => {
  if(dragTask.value.columnId === props.column.id) return
  ...
  >
    <div class="flex justify-between items-center gap-2">
      ...
      <div class="flex gap-1 shrink-0">
        ...
        <button-ui @click="handleRemoveColumn" color="gray" class="w-10 h-10"> ✕ </button-ui>
